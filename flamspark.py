...
Original file is located at
    https://colab.research.google.com/drive/1Rt59tWczZ82gxglmwQT8ct9954u0BU3y
"""
...
input_folder_path = "/content/Input_Images"
...
for filename in os.listdir(input_folder_path):
    if filename.endswith('.JPG'):  # Assuming the images are in JPG format
        ...
        if human_boxes:
            ...
            draw.rectangle(centered_box, outline='Green', width=25)
